...
│       ├── controller/                # CourseController, EvaluationController, GradeController, SubjectController
│       ├── service/                   # CourseService, EvaluationService, GradeService, SubjectService
...
│       ├── repository/                # AttendanceRepository, AnnotationRepository
...
│       ├── repository/                # MessageRepository, AnnouncementRepository
...
│       ├── entity/                    # Notification
│       ├── dto/                       # EmailRequestDTO, AlertRequestDTO, NotificationResponseDTO
